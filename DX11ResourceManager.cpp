...
#endif
	MString filename = szFileName;
    ID3DBlob* pErrorBlob;
    hr = D3DCompileFromFile(filename.asWChar(), NULL, NULL, szEntryPoint, szShaderModel, dwShaderFlags, 0, ppBlobOut, &pErrorBlob );
